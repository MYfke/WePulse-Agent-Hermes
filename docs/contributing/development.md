...
| `bun run dist:mac`        | Build macOS arm64 distributable                         |
| `bun run dist:win`        | Build Windows x64 distributable                         |
| `bun run build-mac`       | Build macOS arm64 distributable                         |
| `bun run build-mac:arm64` | Build macOS distributable for Apple Silicon only        |
| `bun run build-win`       | Build Windows x64 distributable                         |
