...
const t = (key: string, options?: { defaultValue?: string }) => {
  const labels: Record<string, string> = {
    ...
    'settings.hermesSettings.profiles': 'Profiles',
    'settings.hermesSettings.providers': 'Providers',
    'settings.hermesSettings.persona': 'Persona',
    'settings.hermesSettings.memory': 'Memory',
    'settings.hermesSettings.skills': 'Skills',
    'settings.hermesSettings.tools': 'Tools',
    'settings.hermesSettings.gateway': 'Gateway',
    'settings.hermesSettings.logs': 'Logs',
