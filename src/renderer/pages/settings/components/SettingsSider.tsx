...
const SettingsSider: React.FC<{ collapsed?: boolean; tooltipEnabled?: boolean }> = ({
  ...
  const { menus, groupHeaderAt } = useMemo(() => {
    ...
    const builtinMap: Record<string, SiderItem> = {
      ...
      wepulse: { id: 'wepulse', label: t('settings.wepulse.title'), icon: <User />, path: 'wepulse' },
      'hermes-profiles': {
        id: 'hermes-profiles',
        label: t('settings.hermesSettings.profiles'),
        icon: <User />,
        path: 'hermes-profiles',
      },
      'hermes-providers': {
        id: 'hermes-providers',
        label: t('settings.hermesSettings.providers'),
        icon: <LinkCloud />,
        path: 'hermes-providers',
      },
      'hermes-persona': {
        id: 'hermes-persona',
        label: t('settings.hermesSettings.persona'),
        icon: <Magic />,
        path: 'hermes-persona',
      },
      'hermes-memory': {
        id: 'hermes-memory',
        label: t('settings.hermesSettings.memory'),
        icon: <Info />,
        path: 'hermes-memory',
      },
      'hermes-skills': {
        id: 'hermes-skills',
        label: t('settings.hermesSettings.skills'),
        icon: <Lightning />,
        path: 'hermes-skills',
      },
      'hermes-tools': {
        id: 'hermes-tools',
        label: t('settings.hermesSettings.tools'),
        icon: <LinkCloud />,
        path: 'hermes-tools',
      },
      'hermes-gateway': {
        id: 'hermes-gateway',
        label: t('settings.hermesSettings.gateway'),
        icon: <Communication />,
        path: 'hermes-gateway',
      },
      'hermes-logs': {
        id: 'hermes-logs',
        label: t('settings.hermesSettings.logs'),
        icon: <System />,
        path: 'hermes-logs',
      },
